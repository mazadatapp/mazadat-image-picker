...
class CloseDialog: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let titleL=UILabel()
        titleL.text = langTranslation.translate(text:  "Are you sure you want to close?" , lang: lang)
        ...
        closeHintL.text = langTranslation.translate(text:  "All modifications made will be discarded!" , lang: lang)
        ...
        closeBtn.setTitle(langTranslation.translate(text:  "Yes, Close" , lang: lang), for: .normal)
