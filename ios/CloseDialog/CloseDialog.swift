...
class CloseDialog: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        addConstraints(currentView: frame, MainView: view, centerX: false, centerXValue: 0, centerY: true, centerYValue: 0, top: false, topValue: 0, bottom: false, bottomValue: 0, leading: true, leadingValue: 16, trailing: true, trailingValue: -16, width: false, widthValue: 0, height: true, heightValue: 246)
        ...
        addConstraints(currentView: closeHintL, MainView: frame, centerX: false, centerXValue: 0, centerY: false, centerYValue: 0, top: true, topValue: 178, bottom: false, bottomValue: 0, leading: true, leadingValue: 16, trailing: true, trailingValue: -16, width: false, widthValue: 0, height: false, heightValue: 0)
        ...
        closeBtn.setTitle(lang == "en" ? "Yes, Close" : "نعم، إغلق", for: .normal)
        closeBtn.titleLabel!.font = UIFont(name: "Montserrat-SemiBold", size: 14)
        closeBtn.backgroundColor = Colors.blueColor()
        addConstraints(currentView: closeBtn, MainView: frame, centerX: false, centerXValue: 0, centerY: false, centerYValue: 0, top: false, topValue: 0, bottom: true, bottomValue: 0, leading: false, leadingValue: 0, trailing: true, trailingValue: 0, width: true, widthValue: frame.frame.width*0.5, height: true, heightValue: 40)
